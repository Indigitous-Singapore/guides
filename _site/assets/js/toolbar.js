    ...
    */
    ...
    editButtons.forEach(function (btn) {
        btn.addEventListener('click', function () {
            var repoUrl = 'https://github.com/Indigitous-Singapore/guides' + '/blob/master/'
    ...
    printButtons.forEach(function (btn) {
        btn.addEventListener('click', function () {
            ...
            var replacedRepoName = 'Indigitous-Singapore/guides'.replace(/\//g, '-') + (isProd ? '' : '-staging')
